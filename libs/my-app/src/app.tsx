import { Container, Description, Image } from '@monorepo-apps-nx/ui';
...
export const App = () => (
  <SafeAreaView style={safeAreaViewStyle}>
    <View
      style={[setPadding(8), setBackgroundColor('plum'), setFlexDisplay(1)]}
    >
      ...
      <Container
        style={[setBackgroundColor('yellow'), setPadding(8), marginTopAuto]}
      >
        <Description
          color="red"
          style={[setPadding(10), setBackgroundColor('gold')]}
        >
